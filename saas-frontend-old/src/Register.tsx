import { motion, AnimatePresence } from 'motion/react'; // Проверь версию в package.json
...
function Register() {
  ...
  return (
    // Убрали дублирующий bg-slate-100 из внутреннего div
    <div className="relative flex h-screen w-full items-center justify-center bg-slate-100 overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full flex justify-center">
        <AnimatePresence mode='wait'>
          ...
          {!role && (
            ...
            >
              <motion.h2
                className="bg-linear-to-r from-blue-600 to-emerald-500 bg-clip-text text-4xl font-black text-transparent mb-auto"
          ...
          {isConfirmed && (
            ...
            >
              ...
              <button
                ...
                className="mt-auto text-slate-400 text-sm hover:text-slate-600 transition-colors"
              >
                Отмена
              </button>
            </motion.div>
